...
Este proyecto representa un caso de uso de una aplicación Restful API, desarrollada con las tecnologías más recientes, incluyendo Java 17, Spring Boot 3, Spring Security 6, JWT (JSON Web Tokens), PostgreSQL y JPA (Java Persistence API).
